...
section .data
    ...
    dword_parray dd 1392, 12544, 7992, 6992, 7202, 27187, 28789, 17897, 12988, 17992
    print_format db "Array sum is ", 0
    print_pformat db "Array psum is ", 0
...
add_dword_parray_element:
    mov ebx, dword [dword_parray + ecx * 4 - 4]
    imul ebx, ebx
    mov edx, ebx
    add eax, edx
    loop add_dword_parray_element ; Decrement ecx, if not zero, add another element.

    PRINTF32 `%s\x0`, print_pformat
    PRINTF32 `%u\n\x0`, eax
